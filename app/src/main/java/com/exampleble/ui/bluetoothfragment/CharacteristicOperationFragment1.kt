...
class CharacteristicOperationFragment1 : Fragment() {
    ...
    fun showData() {
        ...
        val characteristic = (activity as MobileActivity).getCharacteristic()
        val charaProp = (activity as MobileActivity).getCharaProp()
        ...
        if (childList.contains(child)) {
            ...
            txt_title.text =
                characteristic.getUuid()
                    .toString() + requireActivity().getString(R.string.data_changed)
