...
import com.exampleble.databinding.FragmentRearDoorPermissionsBinding
...
class RearDoorPermissionsFragment : BaseFragment() {
    lateinit var mBinding: FragmentRearDoorPermissionsBinding
    ...
    override fun getInflateResource(): Int {
        return R.layout.fragment_rear_door_permissions
    }
    ...
    private fun setViews() {
        ...
        mBinding.incAppBar.txtDesc.text = "Rear Door Permission"
...
//                    runOnUiThread(Runnable { addText(txt, "notify success") })
    ...
    private fun readData() {
        getBLEConfiguration {
            if (it) {
                writeData(ReadRequestConstants.DoorPermissionRear) { writeSuccess ->
                    if (writeSuccess) {
                        //openCloseNotification(true)
                    } else {
                        Toast.makeText(
                            requireContext(),
                            "Can't Connect to Rear Door Config ",
                            Toast.LENGTH_SHORT
                        ).show()
                    }
                }
