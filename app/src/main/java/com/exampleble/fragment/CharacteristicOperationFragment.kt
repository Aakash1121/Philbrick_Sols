...
import kotlinx.android.synthetic.main.fragment_characteric_operation.*
...
class CharacteristicOperationFragment: Fragment() {
    ...
    fun showData() {
        val bleDevice = (requireActivity() as MainActivity).getBleDevice()
        val characteristic = (requireActivity() as MainActivity).getCharacteristic()
        val charaProp = (requireActivity() as MainActivity).getCharaProp()
        ...
        if (childList.contains(child)) {
            ...
            when (charaProp) {
                ...
                PROPERTY_WRITE -> {
                    ...
                    val btn = view_add.findViewById(R.id.btn) as Button
                    btn.setText(requireActivity()!!.getString(R.string.write))
                    btn.setOnClickListener(View.OnClickListener {
                        ...
                        Log.i("ServicesUUID",characteristic.getService().uuid.toString())
                        Log.i("CHARACUUID",characteristic.uuid.toString())
                        BleManager.getInstance().write(
                            ...
                            object : BleWriteCallback() {
                                ...
                                override fun onWriteSuccess(
                                    ...
                                    Log.i("WRITEJUST",HexUtil.formatHexString(justWrite).toString())
                                    runOnUiThread(Runnable {
                                        addText(
                ...
                PROPERTY_NOTIFY -> {
                    val view_add = LayoutInflater.from(requireActivity())
                        .inflate(R.layout.layout_characteric_operation_button, null)
                    val btn = view_add.findViewById(R.id.btn) as Button
                    btn.setText(requireActivity().getString(R.string.open_notification))
                    btn.setOnClickListener {
                        if (btn.text.toString() == requireActivity().getString(R.string.open_notification)) {
                            btn.text = requireActivity().getString(R.string.close_notification)
                            ...
                            btn.text = requireActivity().getString(R.string.open_notification)
                ...
                PROPERTY_INDICATE -> {
                    ...
                    btn.setOnClickListener {
                        if (btn.text.toString() == requireActivity()!!.getString(R.string.open_notification)) {
                            btn.setText(requireActivity()!!.getString(R.string.close_notification))
    ...
    private fun addText(textView: TextView, content: String) {
        ...
        edtFireManFloor.setText(content.toString())
